...
export const WRITER_PLATFORM_CONFIG: Record<WriterPlatform, WriterPlatformConfig> = {
  wechat: {
    ...
    label: "公众号文章写手",
    shortLabel: "公众号",
    description: "适合输出深度分析、案例拆解和可复用的方法论文章。",
    audience: "行业从业者、企业决策者、专业读者",
    tone: "专业、可信、分析型",
    formatGuidance: "长文结构化输出，必须包含标题、导语、章节标题、案例或数据、总结与行动建议。",
    wordRange: "1500-3200 字",
    imageAspectRatio: "16:9",
    imageStyle: "专业、简洁、偏编辑插图或信息图",
    imageCount: "2-4 张",
    copyHint: "适合直接复制 Markdown 正文，图片单独下载后插入公众号后台。",
    supportsThread: false,
    skillStack: ["content-creation", "research-enhanced", "image-generation"],
    toolStack: ["Google Search", "Jina Reader", "Nano Banana prompt workflow", "Markdown draft uploader"],
  ...
  xiaohongshu: {
    ...
    tone: "友好、口语化、强钩子",
    formatGuidance: "短段落输出，强调标题钩子、分点清晰、结尾带互动与标签。",
    wordRange: "300-900 字",
    imageAspectRatio: "3:4",
    imageStyle: "明亮、生活化、封面大字报风格",
    imageCount: "3-6 张",
    copyHint: "建议复制正文文本并逐张下载封面/配图，再在小红书发布器中排版。",
    supportsThread: false,
    skillStack: ["content-creation", "research-enhanced", "image-generation"],
  ...
  x: {
    ...
    tone: "直接、清晰、观点驱动",
    formatGuidance: "支持单篇长文和线程模式；线程模式需拆分为多段短帖并保留主线。",
    wordRange: "长文 600-1400 字 / 线程 6-12 段",
    imageAspectRatio: "16:9",
    imageStyle: "简洁、科技感、适合横向分享图",
    imageCount: "1-3 张",
    copyHint: "长文可整体复制，线程模式建议逐段复制；图片用下载或复制图链方式发布。",
    supportsThread: true,
    skillStack: ["content-creation", "research-enhanced", "image-generation"],
  ...
  facebook: {
    ...
    tone: "亲和、叙事性、可分享",
    formatGuidance: "支持长文与多段帖文；需要兼顾品牌故事、观点表达和互动提问。",
    wordRange: "长文 800-1800 字 / 多段帖文 4-8 段",
    imageAspectRatio: "16:9",
    imageStyle: "温暖、品牌感、易于社交传播",
    imageCount: "1-4 张",
    copyHint: "适合复制正文后在 Facebook Composer 微调，图片分批下载并上传。",
    supportsThread: true,
    skillStack: ["content-creation", "research-enhanced", "image-generation"],
...
export function getWriterModeOptions(platform: WriterPlatform) {
  if (WRITER_PLATFORM_CONFIG[platform].supportsThread) {
    return [
      { value: "article" as const, label: "单篇长文", description: "适合一篇完整文章或单帖长内容。" },
