...
const MIN_IMAGE_ASSISTANT_TIMEOUT_MS = 180_000
const IMAGE_ASSISTANT_PROVIDER_TOTAL_TIMEOUT_MS = Math.max(
  MIN_IMAGE_ASSISTANT_TIMEOUT_MS,
...
const IMAGE_ASSISTANT_PROVIDER_TIMEOUT_MS = Math.max(
  MIN_IMAGE_ASSISTANT_TIMEOUT_MS,
  Number.parseInt(process.env.IMAGE_ASSISTANT_PROVIDER_TIMEOUT_MS || "", 10) || MIN_IMAGE_ASSISTANT_TIMEOUT_MS,
)
