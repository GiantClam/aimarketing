...
const SKILL_REGISTRY: Record<string, AiEntrySkillDefinition> = {
  "headline-generator": {
    ...
    description: "SEO title method for distinct, search-intent-aware title candidates with explicit evidence boundaries.",
    type: "prompt",
    triggerHints: ["seo title", "headline", "title tag", "SEO 标题", "标题优化"],
    instruction: [
      "Generate distinct SEO title angles from the user-provided page intent, audience, and value proposition.",
      "Do not claim live SERP, competitor, search-volume, ranking, GSC, GA4, or CTR evidence unless a permitted tool returned it in this task.",
      "Separate deterministic title checks from model judgment and avoid unsupported performance promises.",
    ].join(" "),
  ...
  "meta-creator": {
    id: "meta-creator",
    name: "Meta Creator",
    description: "SEO metadata method for titles and descriptions aligned to an approved page brief.",
    type: "prompt",
    triggerHints: ["meta description", "meta title", "metadata", "Meta 描述"],
    instruction: "Create concise title tags and meta descriptions from the confirmed page brief. Do not imply ranking or CTR guarantees.",
    toolIds: [],
    mcpServerIds: [],
    version: "2026-07-31",
  },
  "keyword-mapper": {
    id: "keyword-mapper",
    name: "Keyword Mapper",
    description: "Maps supplied keywords to intent and page roles without fabricating demand data.",
    type: "prompt",
    triggerHints: ["keyword map", "keyword clustering", "关键词地图", "关键词聚类"],
    instruction: "Map supplied keywords by intent and page role. Request a permitted data tool before making demand, difficulty, or ranking claims.",
    toolIds: [],
    mcpServerIds: [],
    version: "2026-07-31",
  },
  "content-analyzer": {
    ...
    description: "Audits supplied content against a stated audience, intent, and page objective.",
    type: "prompt",
    triggerHints: ["content audit", "content analysis", "内容审计", "内容分析"],
    instruction: "Separate observed page evidence from inferred recommendations. Do not fabricate competitor, ranking, or conversion evidence.",
    toolIds: [],
    mcpServerIds: [],
    version: "2026-07-31",
  },
  "seo-optimizer": {
    id: "seo-optimizer",
    name: "SEO Optimizer",
    description: "Turns a confirmed diagnosis into an evidence-aware SEO optimization backlog.",
    type: "prompt",
    triggerHints: ["seo optimization", "seo audit", "SEO 优化", "SEO 审计"],
    instruction: "Prioritize fixes by objective and available evidence. Label recommendations as hypotheses when live data is unavailable.",
    toolIds: [],
    mcpServerIds: [],
    version: "2026-07-31",
  },
