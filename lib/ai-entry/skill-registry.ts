...
const SKILL_REGISTRY: Record<string, AiEntrySkillDefinition> = {
  ...
  "ppt-master": {
    ...
    instruction: [
      ...
      "After the brief is complete and the user confirms it, use recommend_ppt_templates to select one to four exact ids from the full ppt-master catalog. The recommendation must be based on the complete brief and conversation context.",
      "Only call preview_ppt_deck after the user has selected one of the recommended templates, passing that exact templateId.",
