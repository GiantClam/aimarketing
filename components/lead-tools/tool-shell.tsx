  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="public-grid-bg public-tool-shell mx-auto max-w-7xl">
        ...
        {faq.length > 0 ? (
          <section className="mt-10 space-y-4 rounded-[2rem] border border-border/70 bg-card/85 p-4 md:p-5">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              {faq.map((item) => (
                <div key={item.question} className="rounded-2xl border border-border/70 bg-background/75 p-4">
