  ...
  if (locale === "zh") {
    return {
      ...
      categoryDescriptions: {
        ...
        image_generation: "支持阿里云百炼 Qwen Image 3.0 / 2.7、Google Nanobanana2、OpenAI gpt-image-2、OpenAI Compatible 图片接口，以及 RunningHub 文生图 / 图生图工作流。",
        video_generation: "支持阿里云百炼 HappyHorse、MiniMax 海螺、Gemini Veo 3.1、Seedance 官方接口，以及 RunningHub API。",
  ...
  return {
    ...
    categoryDescriptions: {
      text_generation: "Supports OpenAI Compatible plus official Qwen, MiniMax, GLM, and Volcengine (Doubao / DeepSeek) APIs. OpenRouter is supported as a manually configured OpenAI-compatible provider rather than a platform default.",
        image_generation: "Supports Alibaba Cloud Bailian Qwen Image 3.0 / 2.7, Google Nanobanana2, OpenAI gpt-image-2, OpenAI Compatible image APIs, and RunningHub text-to-image / image-to-image workflows.",
        video_generation: "Supports Alibaba Cloud Bailian HappyHorse, official MiniMax Hailuo, Gemini Veo 3.1, Seedance, and RunningHub APIs.",
