...
function getCopy(locale: AppLocale): Copy {
  if (locale === "zh") {
    return {
      ...
      modelEditorBody: "在这里选择 provider、填写展示名称、默认模型与 API Key。若选择 OpenAI Compatible，还需要填写 Base URL。",
  ...
  return {
    ...
    modelEditorBody: "Choose a provider here, then fill in the display label, default model, and API key. OpenAI Compatible also requires a Base URL.",
    providerRoutingTitle: "Provider Routing",
