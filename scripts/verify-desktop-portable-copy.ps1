...
try {
  ...
  foreach ($relative in @("AI Marketing.exe", "README.txt", "_up_/dist-runtime/host.mjs", "_up_/dist-runtime/runtime/runtime-manifest.json", "_up_/dist-runtime/skills/ppt-master/SKILL.md")) {
  ...
  $runtimeEntries = @("_up_/dist-runtime/host.mjs", "_up_/dist-runtime/runtime/runtime-manifest.json", "_up_/dist-runtime/skills/ppt-master/SKILL.md")
