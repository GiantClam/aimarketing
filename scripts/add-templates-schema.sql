-- Database migration to add templates functionality
-- Add templates table for workflow configurations
...
INSERT INTO templates (name, description, category, is_official, workflow_type, api_url, input_fields) VALUES
