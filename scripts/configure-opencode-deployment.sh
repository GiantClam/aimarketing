...
DEEPSEEK_PROVIDER_MODEL="${AI_ENTRY_DEEPSEEK_MODEL:-${DEEPSEEK_MODEL:-deepseek-v4-pro}}"
...
vercel_set AI_ENTRY_DEEPSEEK_MODEL "$DEEPSEEK_PROVIDER_MODEL"
vercel_set DEEPSEEK_MODEL "$DEEPSEEK_PROVIDER_MODEL"
