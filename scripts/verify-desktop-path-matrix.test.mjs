...
test("Windows path matrix verifier covers non-ASCII, spaces, long and OneDrive-shaped paths", async () => {
  ...
  for (const marker of ["0x4E2D", "0x6587", "0x7528", "0x6237", "CoworkAny space path", "OneDrive - CoworkAny", "Start-Process", "tar.exe", "New-Item -ItemType Junction", "portable-copy verifier", "cleanVm = $false"]) {
