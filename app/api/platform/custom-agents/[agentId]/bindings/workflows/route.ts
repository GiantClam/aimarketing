...
import { setCustomAgentWorkflowBindings } from "@/lib/platform/custom-agents"
...
export async function PUT(
  ...
  try {
    ...
    const data = await setCustomAgentWorkflowBindings({
    ...
    const message = error instanceof Error ? error.message : "custom_agent_workflow_bindings_failed"
    const status =
