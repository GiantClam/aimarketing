...
import { archiveCustomAgent } from "@/lib/platform/custom-agents"
...
export async function POST(
  ...
  try {
    ...
    const data = await archiveCustomAgent({
    ...
    const message = error instanceof Error ? error.message : "custom_agent_archive_failed"
