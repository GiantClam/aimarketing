...
import { publishCustomAgent } from "@/lib/platform/custom-agents"
...
export async function POST(
  ...
  try {
    ...
    const data = await publishCustomAgent({
    ...
    const message = error instanceof Error ? error.message : "custom_agent_publish_failed"
