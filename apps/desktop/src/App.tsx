...
function DesktopMediaWorkspace(props: DesktopMediaWorkspaceProps) {
  ...
  useEffect(() => { setActiveFeatureId(isVideo ? ((Object.entries(actionByFeature).find(([, action]) => action === workflowAction)?.[0] as MediaFeatureId | undefined) ?? "text-to-video") : null); }, [isVideo, workflowAction]);
