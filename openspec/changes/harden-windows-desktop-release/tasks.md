...
- [ ] 5.6 执行 desktop 全量 E2E 与 SaaS lint/build/regression
  ...
  - [x] 2026-08-14 latest i18n source was rebuilt with `pnpm --filter @aimarketing/desktop exec tauri build --no-bundle`; the release EXE stayed alive for 8 seconds and exited cleanly after the probe. The current EXE remains `NotSigned`; installer bundling is tracked separately from this app-binary smoke.
