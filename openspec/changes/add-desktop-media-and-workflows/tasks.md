...
- [x] 所有阶段与质量门禁通过 — 2026-08-14 Desktop 119/119, desktop build, bundle-boundary scan, root TypeScript and lint pass; real-provider scope remains LLM/image/audio plus the separately verified non-Seedance video profile, with Seedance intentionally excluded.
