...
**Quality Gate:**
- [x] Desktop shell test、typecheck、static build 和 Rust build 通过 — 2026-08-14 current Desktop 119/119、TypeScript typecheck、Vite production build 和 Tauri Rust tests 39/39 通过。
...
- Evidence (2026-08-14): Desktop RPC framing, host-session reverse-service, cancellation/event, oversized-frame and malformed-frame suites pass; the current Rust suite is 39/39 and Desktop suite is 119/119.
...
**Quality Gate:**
- [x] 并发/反向 RPC 与取消 tests 通过 — 2026-08-14 current Desktop 119/119, Rust 39/39, and workflow/foreach host integration paths passed with framed service responses.
