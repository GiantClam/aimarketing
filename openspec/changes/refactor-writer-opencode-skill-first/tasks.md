...
- [x] 9.3 Run the complete Writer unit, integration, route, billing, recovery, runtime, Skill, TypeScript, and ESLint suites.
  - [x] 2026-08-14 Writer Skill/contract, asset, asset-runtime, revision, UI, session recovery, root TypeScript and ESLint suites all pass; current Desktop 126/126, shared boundary/provenance checks, and both Writer browser scenarios pass. Browser/production smoke gates remain separately open.
