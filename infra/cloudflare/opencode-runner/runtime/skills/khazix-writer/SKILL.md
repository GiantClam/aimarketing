...
8. **署名与联系方式**：成文中不得附带作者署名、投稿说明、爆料说明或联系邮箱。固定尾部只保留互动引导和告别语
...
**L1-5 署名与联系方式检查**
确认全文没有作者署名、投稿或爆料说明、联系邮箱；出现则整行删除。
